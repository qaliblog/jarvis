...
- PR #10809: https://github.com/anomalyco/Jarvis/pull/10809
- PR #11496: https://github.com/anomalyco/Jarvis/pull/11496

## Do Not Translate (Locale Additions)

- `Jarvis` (preserve casing in prose; keep `Jarvis` only in commands, package names, paths, or code)
- `Jarvis CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
