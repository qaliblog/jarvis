...
Use this folder for locale-specific translation guidance that supplements `.Jarvis/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/Jarvis/pull/12345

## Do Not Translate (Locale Additions)

- `Jarvis` (preserve casing)
