...
- PR #15835: https://github.com/anomalyco/Jarvis/pull/15835

## Do Not Translate (Locale Additions)

- `Jarvis` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `Jarvis` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Jarvis` in prose, `Jarvis` only for exact technical identifiers
...
- Avoid changing `Jarvis` to `Jarvis` inside commands, URLs, package names, or code literals
