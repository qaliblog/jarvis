...
Desktop application and browser-based app issues, including `Jarvis web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core Jarvis server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Jarvis Zen, Jarvis Go, and billing issues.
