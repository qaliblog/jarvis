import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@jarvis-ai/sdk/v2"
import { SessionTurn } from "@jarvis-ai/ui/session-turn"
import { SessionReview } from "@jarvis-ai/ui/session-review"
import { DataProvider } from "@jarvis-ai/ui/context"
import { FileComponentProvider } from "@jarvis-ai/ui/context/file"
import { WorkerPoolProvider } from "@jarvis-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@jarvis-ai/ui/logo"
import { IconButton } from "@jarvis-ai/ui/icon-button"
import { ProviderIcon } from "@jarvis-ai/ui/provider-icon"
import { iife } from "@jarvis-ai/core/util/iife"
import { Binary } from "@jarvis-ai/core/util/binary"
import { NamedError } from "@jarvis-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@jarvis-ai/ui/tabs"
import { MessageNav } from "@jarvis-ai/ui/message-nav"
import { FileSSR } from "@jarvis-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@jarvis-ai/ui/pierre/worker").then((m) => ({
