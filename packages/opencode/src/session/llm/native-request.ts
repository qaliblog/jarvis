import type { JsonSchema, LLMRequest, ProviderMetadata } from "@jarvis-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@jarvis-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @jarvis-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
