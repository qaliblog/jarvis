...
beforeAll(async () => {
  ...
  mock.module("@jarvis-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@jarvis-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@jarvis-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@jarvis-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
